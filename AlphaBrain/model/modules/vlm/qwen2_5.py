...
class _QWen_VL_Interface(nn.Module):
    ...
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        # 框架内部自动控制：自包含checkpoint场景下用meta device创建架构骨架，权重由框架统一加载
        # meta device + to_empty后需要手动重建inv_freq等non-persistent buffer，
        # 因为这些buffer不在state_dict中，load_state_dict无法恢复
...
if __name__ == "__main__":
    ...
    model_id = "./data/pretrained_models/Qwen2.5-VL-3B-Instruct"
